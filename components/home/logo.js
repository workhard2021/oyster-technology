...
export const Logo=({data,logo})=>{
    return (<>
          <nav className='relative top-0 left-0 w-screen'>
            <div className="w-full fixed top-0 left-0 flex justify-between z-10 md:p-8 p-4">
               ...
               <div className="w-[50%] flex justify-end items-center">
                  <Link target={'_blank'} href="https://web.facebook.com">
                         <BsFacebook className="hover:text-gray-200 transition-all duration-75 inline-block m-3 text-white" size={28}/>
                  </Link>
                  <Link  target={'_blank'} href="https://web.facebook.com">
                         <BsLinkedin className="hover:text-gray-200 transition-all duration-75 inline-block m-3 text-white" size={28}/>
                  </Link>
                  <Link  target={'_blank'} href="https://web.facebook.com">
                         <BsTwitter className="hover:text-gray-200 transition-all duration-75 inline-block m-3 text-white" size={28}/>
                  </Link>
                  <Link  target={'_blank'} href="https://web.facebook.com">
            ...
            <div className="relative flex justify-center items-center md:flex-nowrap flex-wrap w-full h-full">
               
              {[data.map((value,index)=>{
             return <Link href={value.url} key={index} id={`hover_logo_${index+1}`} className="relative md:h-screen h-[50vh] w-full bg-url flex justify-center items-center flex-wrap" style={{backgroundImage:`url(${value.image})`}}>
